...
The v1 CLI reads a Markdown input file or inline Markdown prompt text, writes report artifacts under `.ai/artifacts`, and keeps code file writes inside the configured folder guard.
