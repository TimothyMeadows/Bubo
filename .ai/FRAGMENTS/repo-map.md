...
- `src/LocalAgent.Runtime`: workspace guarding, run orchestration, one-shot inference action proposal, output/report artifact generation, deterministic file tools, Docker-backed Git/command tools, and tool dispatch.
